                    ...
                    case 2: // Exit
                        ...
                        switch (gas)
                        {
                            case 1:
                                ...
                                Console.WriteLine($"Your total earning for Diesel is {DieselEarned:F2}.");
                                ...
                                Console.WriteLine($"You can refill {RefillLiter:F2} liters of Diesel");
                                break;
                            case 2:
                                ...
                                Console.WriteLine($"Your total earning for Premium is {PremiumEarned}.");
                                Console.Write("\nHow much Premium do you want to refill?: ");
                                double PremiumRefill = Convert.ToInt32(Console.ReadLine());
                                double PremiumLiter = PremiumRefill / PremiumMarketPrice;
                                Console.WriteLine($"You can refill {PremiumLiter:F2} liters of Premium");
                                break;
                            case 3:
                                ...
                                Console.WriteLine($"Your total earning for Gasoline is {GasolineEarned:F2}.");
                                Console.Write("\nHow much Gasoline do you want to refill?: ");
                                double GasolineRefill = Convert.ToInt32(Console.ReadLine());
                                double GasolineLiter = GasolineRefill / GasolineMarketPrice;
                                Console.WriteLine($"You can refill {GasolineLiter:F2} liters of Gasoline");
                                break;
                            case 4:
                                ...
                                Console.WriteLine($"Your total earning for Kerosene is {KeroseneEarned:F2}.");
                                Console.Write("\nHow much Kerosene do you want to refill?: ");
                                double KeroseneRefill = Convert.ToInt32(Console.ReadLine());
                                double KeroseneLiter = KeroseneRefill / KeroseneMarketPrice;
                                Console.WriteLine($"You can refill {KeroseneLiter:F2} liters of Kerosene");
                                break;
                            case 5:
                                ...
                                Console.WriteLine($"Your total earning for Unleaded is {UnleadedEarned:F2}.");
                                Console.Write("\nHow much Unleaded do you want to refill?: ");
                                double UnleadedRefill = Convert.ToInt32(Console.ReadLine());
                                double UnleadedLiter = UnleadedRefill / UnleadedMarketPrice;
                                Console.WriteLine($"You can refill {UnleadedLiter:F2} liters of Unleaded");
                                break;
                            case 6:
                                ...
                                Console.WriteLine($"Your total earning for Petrol is {PetrolEarned:F2}.");
                                Console.Write("\nHow much Petrol do you want to refill?: ");
                                double PetrolRefill = Convert.ToInt32(Console.ReadLine());
                                double PetrolLiter = PetrolRefill / PetrolMarketPrice;
                                Console.WriteLine($"You can refill {PetrolLiter:F2} liters of Petrol");
                                Console.WriteLine("You earned {}pesos");
                                break;
                        }
                        break;
                    default:
